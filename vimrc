...
Bunele 'SirVer/ultisnips'
Bunele 'honza/vim-snippets'
Bunele 'elzr/vim-json'
Bunele 'mattn/webapi-vim'
Bunele 'mattn/gist-vim'
Bunele 'aklt/plantuml-syntax'
Bunele 'solarnz/thrift.vim'
